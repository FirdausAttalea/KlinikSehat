    ...
    <div class="sm:ml-64" style="padding-top: 5rem">
        ...
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-center text-gray-500 dark:text-gray-400">
                <caption style="caption-side: top;" class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    JADWAL
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daftar Jadwal Dokter yang Tersedia di Klinik Kami.</p>
                </caption>
                <thead class="text-xs text-gray-700 text-center uppercase bg-green-100 dark:bg-green-100 dark:text-gray-400">
                    <tr>
                ...
                <tbody class="text-center">
                    <?php foreach ($jadwals as $jadwal) : ?>
                        <tr>
                            <td class="px-6 py-4" style="color: black;"><?php echo $jadwal['dokter_nama']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $jadwal['tanggal']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $jadwal['jam_mulai']; ?></td>
                            <td class="px-6 py-4" style="color: black;"><?php echo $jadwal['jam_selesai']; ?></td>
                            <td class="px-6 py-4">
                                <a href="?c=JadwalController&m=edit&id=<?php echo $jadwal['id']; ?>" 
                                    class="text-teal-600 hover:text-teal-500 mr-4"
                                    style="text-decoration: none;">
                                    Edit
                                </a>
                                <a href="?c=JadwalController&m=delete&id=<?php echo $jadwal['id']; ?>" 
