            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-pembayaran" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="index.php?c=PembayaranController&m=create" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-teal-600 hover:text-teal-500 mr-4" 
                            style="color: #008080; text-decoration: none;" onmouseover="this.style.color='#004c4c'" onmouseout="this.style.color='#008080'">
                                Tambah Pembayaran</a>
                        </li>
                    </ul>
    ...
    <div class="sm:ml-64" style="padding-top: 5rem">
        <div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
            <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <!-- MULAI DARI SINI -->
                <form class="space-y-6" action="index.php?c=JadwalController&m=edit&id=<?php echo $jadwalData['id']; ?>" method="POST">
                    <h5 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="text-align:center">Edit Jadwal</h5>
                    <div>
                        <label for="dokter_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dokter</label>
                        <select name="dokter_id" id="dokter_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            <?php foreach ($dokters as $dokter) : ?>
                                <option value="<?php echo $dokter['id']; ?>" <?php echo $jadwalData['dokter_id'] == $dokter['id'] ? 'selected' : ''; ?>><?php echo $dokter['nama']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div>
                        <label for="tanggal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal</label>
                        <input type="date" name="tanggal" id="tanggal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $jadwalData['tanggal']; ?>" required>
                    </div>
                    <div>
                        <label for="jam_mulai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Mulai</label>
                        <input type="time" name="jam_mulai" id="jam_mulai" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $jadwalData['jam_mulai']; ?>" required>
                    </div>
                    <div>
                        <label for="jam_selesai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Selesai</label>
                        <input type="time" name="jam_selesai" id="jam_selesai" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="<?php echo $jadwalData['jam_selesai']; ?>" required>
                    </div>
